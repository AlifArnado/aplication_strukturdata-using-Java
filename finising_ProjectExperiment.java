...
public class finising_ProjectExperiment {
  ...
  //     private String[] distributor = {"PT.Japfa","PT.Indomilk","PT.Nusantara","PT.Yudistira","PT.Clock","PT.Pulpen"};
  ...
  //                               System.out.println("  Masih Proses");
    ...
    //                               System.out.println("  Masih Proses");
                                     System.out.println("  Menu : "+membukaMenu+" tidak ada dalam pilihan");
                                     System.out.println(" ");
                             }
   ...
   //                        System.out.println("  Masih Proses");
							 ...
							 System.out.println("  Jika memilih Sub Menu 5 Maka Keluar Form Menampilkan");
                             System.out.println("  ");
					     }
   ...
   //                    System.out.println("  Masih Proses");
         ...
         public  void subMenuMencari() {
               ...
               do {
                       ...
                       System.out.println("  | [ 2.] Kembali kemenu utama            |");
                       System.out.println("  +---------------------------------------+");
                         System.out.print("  pilih [1 - 2] : open Submenu ");
    ...
    //      deklarasi variabel
            ...
            do {
                i++;
                    ...
                    System.out.println(" ");
                    System.out.println("  Pesan Konfirmasi input data");
    ...
    public static void menampilkandataKelontong(String[] namaBarang,int[] kodeBarang, String[] distributor, int[] harga) {
      ...
      System.out.println(" ");
          ...
          for (i = N ; i >= 1 ; i-- ) {
           ...
           System.out.println("  ");
             System.out.print("  Lihat Data ( Iya / Tidak ) : ");
		   lihatDataBaru = masukanNama.next();
		       if (lihatDataBaru.equalsIgnoreCase("iya")) {
		           menampilkandataKelontong(namaBarang, kodeBarang, distributor, harga);
		       } else {
		           System.out.println("  ");
               }
